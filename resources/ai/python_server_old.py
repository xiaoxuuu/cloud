...
def load_models():
    ...
    chat_model = AutoModelForCausalLM.from_pretrained(chat_model_path, local_files_only=True, trust_remote_code=True, attn_implementation="flash_attention_2", device_map="auto").eval()
